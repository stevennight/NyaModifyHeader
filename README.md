...
管理页支持全部规则的搜索、筛选、新建、编辑、复制、删除、启停、导入和导出。每条规则可以包含多项 Header 修改。
...
这是 Nya Header 自己的简化语法，不是 Google 搜索语法，也不是直接暴露 Chrome DNR `urlFilter`。
